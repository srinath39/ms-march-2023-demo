		...
		public boolean login(String username, String password) throws SQLException {
	        ...
	        if(resultSet.next()){
	            ...
	            if(resultSet.getString(1).equals(password)){
	                ...
	                JOptionPane.showMessageDialog(loginFrame,"The password you entered is invalid.","Invalid password",1);
	                return false;
	            }
	        }
	        else {
	            
	            JOptionPane.showMessageDialog(loginFrame,"The username you entered does not exist.","Invalid username",1);
	            return false;
	        }
	    }
